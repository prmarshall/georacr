...
- **Air drag coefficient:** Determines top speed. Formula: `airDragCoefficient = totalEngineForce / targetTopSpeed²` (speed in m/s, totalEngineForce = accelerate × numDriveWheels). Applied via `addForce` on chassis, NOT `setWheelBrake`.
